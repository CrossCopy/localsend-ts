...
import type { DeviceInfo, PrepareUploadRequest, PrepareUploadResponse, PrepareDownloadResponse, FileMetadata } from '../types';
...
export class LocalSendServer {
  ...
  constructor(deviceInfo: DeviceInfo, options: { saveDirectory?: string, requirePin?: boolean, pin?: string } = {}) {
